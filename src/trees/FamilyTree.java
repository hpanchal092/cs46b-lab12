...
public class FamilyTree {
	...
	private void addLine(String line) throws TreeException {
		...
		// String parent = ?? The substring of line that starts at char #0 and ends just
		// before colonIndex. Check the API for
		// class java.util.String, method substring(), if you need guidance.
		// String childrenString = ?? The substring of line that starts just after
		// colonIndex and goes through the end of
		// the line. You'll use a different version of substring().
		// String[] childrenArray = ?? Call childrenString.split(). Check the API for
		// details. The result will be an array
		...
		// else
		// {
		// parentNode = root.????? There's a method in Node that searches for a named
		// node.
